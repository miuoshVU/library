...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorProposedBook", b =>
                {
                    b.Property<int>("AuthorsId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("AuthorsId", "ProposedBooksId");

                    b.HasIndex("ProposedBooksId");

                    b.ToTable("AuthorProposedBook");
                });
            ...
            modelBuilder.Entity("CategoryProposedBook", b =>
                {
                    b.Property<int>("CategoriesId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("CategoriesId", "ProposedBooksId");

                    b.HasIndex("ProposedBooksId");

                    b.ToTable("CategoryProposedBook");
                });
            ...
            modelBuilder.Entity("Library.CodeFirstDatabase.Entities.DBOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Library.CodeFirstDatabase.Entities.LogEntry", b =>
                {
                    ...
                    b.Property<string>("EnteryDescription")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Library.CodeFirstDatabase.Entities.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Library.CodeFirstDatabase.Entities.LogEntry", b =>
                {
                    b.HasOne("Library.CodeFirstDatabase.Entities.DBOperation", "DbOperation")
                        .WithMany("LogEntries")
            ...
            modelBuilder.Entity("Library.CodeFirstDatabase.Entities.Vote", b =>
                {
                    b.HasOne("Library.CodeFirstDatabase.Entities.ProposedBook", "ProposedBook")
                        .WithMany("Votes")
                        .HasForeignKey("ProposedBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
